...
@ContentView(R.layout.activity_edit_subject)
public class EditSubjectActivity extends TeacherBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_subject_name.setText(mSubject.getSubjectName());
        et_answer.setText(mSubject.getAnswer());
        et_course.setText(mSubject.getCourseName());
        et_A.setText(mSubject.getA());
        et_B.setText(mSubject.getB());
        et_C.setText(mSubject.getC());
        et_D.setText(mSubject.getD());
    }
    ...
    private void addSubject() {
        ...
        params.addBodyParameter("method", Server.SERVER_UPDATE_QUESTION);
